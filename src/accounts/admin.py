...
class UserAdmin(UserAdmin):
    ...
    list_display = (
        ...
        "dealership_license_phone_number",
        "contact_person_name",
        "last_login",
        "is_superuser",
        "is_approved",
    ...
    fieldsets = (
        ...
        ('Personal Info', {'fields': ['dealership_name', 'dealership_license_number', 'dealership_license_phone_number', 'contact_person_name', 'phone_number', 'gumtree_dealarship_url', 'facebook_dealership_url']}),
    ...
    add_fieldsets = (
        (None, {"classes": ("wide",), "fields": ("email", "dealership_name", "dealership_license_number", "dealership_license_phone_number", "contact_person_name", "phone_number", "gumtree_dealarship_url", "facebook_dealership_url", "is_approved",)}),
