...
from .views import (
    ...
    verify_listing_active,
    get_facebook_listings_pending_removal,
...
urlpatterns = [
    ...
    path('facebook-listings-pending-removal/', get_facebook_listings_pending_removal, name='get_facebook_listings_pending_removal'),
