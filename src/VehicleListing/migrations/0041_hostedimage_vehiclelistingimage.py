    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('thumbnail_image', models.CharField(blank=True, default='', max_length=512)),
                ('medium_image', models.CharField(blank=True, default='', max_length=512)),
                ('large_image', models.CharField(blank=True, default='', max_length=512)),
